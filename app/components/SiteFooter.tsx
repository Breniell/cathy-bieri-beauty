...
export default function SiteFooter() {
  return <footer className="site-footer">
    ...
    <div className="footer-main">
      ...
      <div className="footer-nav"><small>Nous joindre</small><a href={contact.phoneHref}>{contact.phoneDisplay}</a><a href={`mailto:${contact.email}`}>{contact.email}</a><a href={contact.instagram} target="_blank" rel="noreferrer">Instagram @Komobeauty</a><p>Les disponibilités et le lieu sont confirmés personnellement lors de votre demande.</p></div>
    </div>
