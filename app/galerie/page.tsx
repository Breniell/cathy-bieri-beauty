...
export default function GalleryPage() {
  return <SiteShell>
    ...
    <section className="social-strip section-pad"><p>Pour suivre les prochaines créations et les disponibilités</p><Link href="https://www.instagram.com/komobeauty/" target="_blank">Instagram @Komobeauty <span>↗</span></Link></section>
